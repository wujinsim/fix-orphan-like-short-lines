...
- Find short lines by characters, words, or percentage length
- Search all short lines or only lines ending with selected marks
- Use built-in sentence-ending marks for Latin and CJK text
- Create, save, and delete custom ending-mark filters
- Jump directly to each detected line in the document
- Adjust tracking with `-1`, `+1`, or `Auto`
...
[GitHub Issues](https://github.com/wujinsim/fix-orphan-like-short-lines/issues)
...
Developed by Sim Wujin / mulgogi.

© 2026 Sim Wujin. All rights reserved.
